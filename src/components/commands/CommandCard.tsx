...
const CommandCard: FC<CommandCardProps> = memo(
  ({ command, onExpand, categoryColor, categoryBg }) => {
      ...
      >
        ...
        <div className='flex items-start justify-between mb-2'>
          ...
          {command.aliases.length > 0 && (
            <span className={clsx('text-xs', isDarkMode ? 'text-gray-500' : 'text-gray-400')}>
        ...
        <div
          className={clsx(
            ...
            isDarkMode ? 'text-gray-500 border-gray-700' : 'text-gray-500 border-gray-200',
          )}
        >
